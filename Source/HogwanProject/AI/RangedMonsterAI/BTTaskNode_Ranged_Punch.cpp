...
#include "AI/RangedMonsterAI/BTTaskNode_Ranged_Punch.h"

EBTNodeResult::Type UBTTaskNode_Ranged_Punch::ExecuteTask(UBehaviorTreeComponent& _OwnerComp, uint8* NodeMemory)
{
...
void UBTTaskNode_Ranged_Punch::TickTask(UBehaviorTreeComponent& _OwnerComp, uint8* _pNodeMemory, float _DeltaSeconds)
{
